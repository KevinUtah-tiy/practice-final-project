...
$.getJSON(api, function(data) {
  ...
  console.log("The current temperature is: ", data.main.temp + "°F");
  ...
  console.log("The low temperature today is:", data.main.temp_min + "°F");
  console.log("The high temperature today is:", data.main.temp_max + "°F");
  // console.log("The country this is in is: ", data.sys.country);
  console.log("The current weather is: ", data.weather.main);
  console.log("The current weather description is: ", data.weather.description);
